...
// XFAIL: darwin-chimera -- arm64 terminators spill scratch to the guest stack below sp; a
// reserved-register or sysreg scratch redesign is needed (see DARWIN.md).
//
